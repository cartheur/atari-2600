...
setup and then fixed.  A Raspberry Pi~4 hosts camera capture, policy
...
$\rightarrow$ Pi 4 $\rightarrow$ Nano $\rightarrow$ relay contacts
...
\begin{itemize}[leftmargin=*]
  ...
  \item Console, display, camera, Pi, Nano, relay and firmware revisions.
