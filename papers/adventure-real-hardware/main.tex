...
For a recent review of DeepMind's game-RL trajectory---including DQN-style,
model-free approaches and the model-based progression through AlphaGo,
AlphaGo Zero, and MuZero---see Shaheen et al.\ \cite{shaheen2025review}.
